...
np.save('xgb_processed_train_192.npy',train_data)


# In[8]:


train_data=np.load('xgb_processed_train_192.npy')
...
import pickle
pickle.dump(clf, open("xgb_192.pickle.dat", "wb"))
...
np.save('xgb_processed_test_192.npy',test_data)
...
test_data=np.load('xgb_processed_test_192.npy')
...
out.to_csv('xgb192.pickle.dat.csv', index=False)
